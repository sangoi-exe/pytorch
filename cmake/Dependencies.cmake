...
if(USE_GLOO)
  if(NOT CMAKE_SIZEOF_VOID_P EQUAL 8)
    ...
    # install libuv runtime for Gloo transport on Windows
    if(USE_LIBUV)
      set(_libuv_dll "${libuv_ROOT}/bin/uv.dll")
      if(EXISTS "${_libuv_dll}")
        add_library(libuv SHARED IMPORTED)
        message(STATUS "Installing ${_libuv_dll} into ${TORCH_INSTALL_LIB_DIR}")
        install(FILES "${_libuv_dll}" DESTINATION ${TORCH_INSTALL_LIB_DIR} OPTIONAL)
      endif()
    endif()
  endif()
endif()
