...
# set(CMAKE_EXE_LINKER_FLAGS "/machine:x64 /NODEFAULTLIB:LIBCMT" CACHE STRING "" FORCE)
set(CUDA_SDK_ROOT_DIR "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.8" CACHE PATH "" FORCE)
set(CUDA_LIBRARIES "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.8/lib/x64/cuda.lib" CACHE FILEPATH "" FORCE)

set(CUDNN_ROOT "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.8" CACHE PATH "" FORCE)
set(CUDNN_LIBRARY "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.8/lib/x64/cudnn.lib" CACHE FILEPATH "" FORCE)
set(CUDNN_INCLUDE_DIR "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.8/include" CACHE PATH "" FORCE)
...
set(CMAKE_PREFIX_PATH "C:/torch/venv/Lib/site-packages" CACHE PATH "Onde procurar pacotes" FORCE)
# set(CMAKE_PROJECT_INCLUDE "C:/torch/tweak_runtime.cmake" CACHE FILEPATH "Enfiar meu s" FORCE)

# Build options / policies
set(BUILD_TEST OFF CACHE BOOL "" FORCE)
set(C10_BUILD_MAIN_LIB ON CACHE BOOL "" FORCE)
set(OpenMP_CUDA_FLAGS "/openmp" CACHE STRING "" FORCE)
set(OpenMP_CUDA_LIB_NAMES "libiomp5" CACHE STRING "" FORCE)
set(CMAKE_POLICY_DEFAULT_CMP0074 NEW CACHE STRING "" FORCE)
set(CMAKE_POLICY_DEFAULT_CMP0077 NEW CACHE STRING "" FORCE)
