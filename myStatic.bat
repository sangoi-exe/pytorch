...
IF NOT DEFINED CMAKE_BUILD_PARALLEL_LEVEL set CMAKE_BUILD_PARALLEL_LEVEL=%MAX_JOBS%
IF NOT DEFINED TORCH_NVCC_FLAGS set TORCH_NVCC_FLAGS=--threads 1
ECHO [INFO] Paralelismo de build configurado: MAX_JOBS=%MAX_JOBS%, CMAKE_BUILD_PARALLEL_LEVEL=%CMAKE_BUILD_PARALLEL_LEVEL%, TORCH_NVCC_FLAGS=%TORCH_NVCC_FLAGS%
